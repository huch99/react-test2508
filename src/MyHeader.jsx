...
const MyHeader = () => {
    return (
        <div style={{ display: 'flex', alignItems: 'center', height: 80, background: '#fff', borderRadius: 16, margin: '20px auto', maxWidth: 1200, boxShadow: '0 2px 8px #eee', position: 'relative' }}>
            ...
            <nav style={{ position: 'absolute', right: 25, top: 0, height: '100%' }}>
                <ul style={{ listStyle: 'none', display: 'flex', gap: 0, margin: 0, padding: 0, height: 80, alignItems: 'center' }}>
                    <li className="topMenu" style={{ width: 150 }}>탑
                        <ul>
                    ...
                    <li className="topMenu" style={{ width: 150 }}>아우터
                        <ul>
                    ...
                    <li className="topMenu" style={{ width: 150 }}>팬츠
                        <ul>
                    ...
                    <li className="topMenu" style={{ width: 150 }}>악세서리
                        <ul>
